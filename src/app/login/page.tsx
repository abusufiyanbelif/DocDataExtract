...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen">
      <DocuExtractHeader />
      <main className="flex-grow flex flex-col items-center justify-center p-4 animate-slide-in-from-bottom" style={{ animationDelay: '300ms', animationFillMode: 'backwards' }}>
