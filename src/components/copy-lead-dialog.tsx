                ...
                <div className="py-4 space-y-4">
                    ...
                    <div className="space-y-3 pt-2">
                        <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="copy-summary" className="text-sm font-normal">Lead Summary & Details (Always copied)</Label>
                        </div>
                         <div className="flex items-center space-x-2">
                            <Checkbox id="copy-ration" checked={copyRationLists} onCheckedChange={(checked) => setCopyRationLists(!!checked)} disabled={isCopying} />
                            <Label htmlFor="copy-ration" className="text-sm font-normal">Category Item Lists</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="copy-donations" className="text-sm font-normal">Donations (as new records for this lead)</Label>
                        </div>
                    </div>
                </div>
                <DialogFooter>
