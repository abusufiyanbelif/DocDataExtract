    ...
    try {
        ...
        if (error.message) {
            ...
            if (lowerCaseMessage.includes('api key not valid')) {
                clientMessage = "The configured API key is not valid. Please ensure you have a valid GOOGLE_API_KEY set in your .env file.";
        ...
        if (clientMessage.toLowerCase().includes('api key')) {
            clientMessage += " Your application is configured to check for 'GOOGLE_API_KEY' in your .env file."
        }
