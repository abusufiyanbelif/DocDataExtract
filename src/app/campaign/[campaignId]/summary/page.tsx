...
import { ArrowLeft, Loader2, IndianRupee, Target, Users, Gift } from 'lucide-react';
...
export default function CampaignSummaryPage() {
    ...
    const summaryData = useMemo(() => {
        ...
        const fundingProgress = totalKitAmountRequired > 0 ? (totalDonations / totalKitAmountRequired) * 100 : 0;
        ...
        <div className="min-h-screen bg-background text-foreground">
            ...
            <main className="container mx-auto p-4 md:p-8">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">Kit Amount Required</CardTitle>
                    ...
                    <Card className="col-span-1 lg:col-span-3">
                        <CardHeader>
                            ...
                            <CardDescription>
                                {summaryData?.fundingProgress.toFixed(2)}% funded
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
